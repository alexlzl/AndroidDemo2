...
//                Log.e("TAG1", "onInterceptTouchEvent");
...
//                Log.e("TAG1", "onTouchEvent");
//            }
//
//            @Override
//            public void onRequestDisallowInterceptTouchEvent(boolean disallowIntercept) {
//                Log.e("TAG1", "onRequestDisallowInterceptTouchEvent");
//            }
//        });
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewItemTouchListener(recyclerView) {
            ...
            public void onTouchDown(RecyclerView.ViewHolder viewHolder) {
                if(isHasLongClick){
                    Log.e("TAG1", "onTouchDown");
                }
                super.onTouchDown(viewHolder);
            }

            @Override
            public void onItemClick(RecyclerView.ViewHolder vh) {
                Log.e("TAG1", "onItemClick");
